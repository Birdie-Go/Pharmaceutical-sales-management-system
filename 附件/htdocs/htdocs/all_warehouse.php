...
<body>
  ...
  <div class="content">
      <div>
           <font style='color:#ffffff;background-color:transparent;font-size:30px;position:absolute;left:650px;top:110px'>库存盘点</font>
        <dl>
		...
		<table align="center" border="1px" cellpadding="0px" width="1200px" style='position:absolute;left:150px;top:220px'>
			<tr><th>药品编号</th><th>药品名称</th><th>生产批号</th><th>产地</th><th>所属类别</th><th>进价</th><th>单价</th><th>会员折扣</th><th>库存</th><th>包装规格</th><th>生产日期</th><th>有效期</th><th>供应商名称</th><th>联系人</th><th>联系方式</th></tr>
			<?php
        ...
        $link = mysqli_connect('localhost', $user, $password, '医药销售管理系统', '3306');
				...
				$res = mysqli_query($link, "SELECT * FROM 库存盘点");
