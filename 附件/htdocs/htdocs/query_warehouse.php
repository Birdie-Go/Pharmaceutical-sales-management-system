...
<body>
  ...
  <div class="content">
      <div>
           <font style='color:#ffffff;background-color:transparent;font-size:30px;position:absolute;left:650px;top:110px'>库存查询</font>
        <dl>
		...
		<table align="center" border="1px" cellpadding="0px" width="1200px" style='position:absolute;left:150px;top:220px'>
			<tr><th>供应商名称</th><th>生产批号</th><th>产地</th><th>所属类别</th><th>单价</th><th>会员折扣</th><th>库存</th><th>有效期</th></tr>
			<?php
