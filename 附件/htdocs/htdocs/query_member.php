...
<body>
  ...
  <div class="content">
      <div>
           <font style='color:#ffffff;background-color:transparent;font-size:30px;position:absolute;left:650px;top:110px'>会员查询</font>
        <dl>
		...
		<table align="center" border="1px" cellpadding="0px" width="1200px" style='position:absolute;left:150px;top:220px'>
			<tr><th>会员编号</th><th>会员姓名</th><th>联系方式</th><th>药品名称</th><th>单价</th><th>会员折扣</th><th>数量</th><th>总额</th><th>日期</th><th>员工姓名</th></tr>
			<?php
