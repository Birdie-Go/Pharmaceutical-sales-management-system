...
<body>
  ...
  <div class="content">
      <div>
           <font style='color:#ffffff;background-color:transparent;font-size:30px;position:absolute;left:650px;top:110px'>销售报表</font>
        <dl>
		...
		<table align="center" border="1px" cellpadding="0px" width="1200px" style='position:absolute;left:150px;top:220px'>
			<tr><th>收支编号</th><th>药品编号</th><th>药品名称</th><th>单价</th><th>数量</th><th>会员折扣</th><th>总额</th><th>日期</th><th>会员姓名</th><th>员工姓名</th></tr>
			<?php
        ...
        $link = mysqli_connect('localhost', $user, $password, '医药销售管理系统', '3306');
				...
				$res = mysqli_query($link, "SELECT * FROM 销售报表");
