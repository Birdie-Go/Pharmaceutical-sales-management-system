...
<body>
  ...
  <div class="content">
      <div>
           <font style='color:#ffffff;background-color:transparent;font-size:30px;position:absolute;left:650px;top:110px'>员工信息</font>
        <dl>
		...
		<tr><th>用户名</th><th>员工编号</th><th>员工姓名</th><th>联系电话</th></tr>
		<?php
        ...
        $link = mysqli_connect('localhost', $user, $password, '医药销售管理系统', '3306');
				...
				$res = mysqli_query($link, "SELECT * FROM 员工信息");
